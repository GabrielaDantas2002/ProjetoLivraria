	...
	<div class="container-login100" style="background-image: url('./assets/img/bookstore-2.jpg');">
		<div class="wrap-login100 p-l-55 p-r-55 p-t-80 p-b-30">
				...
				<div class="wrap-input100 validate-input m-b-20" data-validate="Enter username or email">
					<input class="input100" type="text" name="loginUsuario" placeholder="username or email" required>
					<span class="focus-input100"></span>
				</div>

				<div class="wrap-input100 validate-input m-b-25" data-validate = "Enter password">
					<input class="input100" type="password" name="senhaUsuario" placeholder="password" required>
					<span class="focus-input100"></span>
				</div>
				...
				<div class="flex-c p-b-112">
					...
					<a href="#" class="login100-social-item">
						<img src="./assets/img/icons/icon-google.png" alt="GOOGLE">
					</a>
				</div>
